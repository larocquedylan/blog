...
7. **Amortized Analysis (if applicable):** In some cases, you’ll want to look at the average time per operation over a sequence of operations, which is where amortized analysis comes in handy.
